...
product: primetime
audience: end-user
user-guide-title: Hulp bij implementatie van Primetime-referenties
user-guide-description: Helpt de TVSDK te begrijpen en de functies te wijzigen om uw persoonlijke player aan te passen.
...
+ Primetime-referentieimplementatie {#reference}
   ...
   + De ontwikkelomgeving instellen {#setup-dev}
      ...
      + [De Primetime-referentieimplementatie maken](set-up-dev-environment/install-the-ref-player-project.md)
   + De code verkennen {#explore-code}
      ...
      + [Voorbeeld-JSON-voederindeling](set-up-dev-environment/exploring-code/example-json-feed-format.md)
   ...
   + Een speler instellen voor DVR-afspelen met advertenties {#dvr}
      ...
      + [Een aangepaste begintijd instellen in de referentie-implementatie](implement-video-playback/dvr/set-custom-start-time-dvr.md)
