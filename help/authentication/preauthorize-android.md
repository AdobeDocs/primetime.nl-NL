...
De methode van de preauthorize API moet door toepassingen worden gebruikt om een pre-vergunningsbesluit voor één of meerdere middelen te verkrijgen. De aanvraag van de API voor voorafgaande toestemming moet worden gebruikt voor UI-tips en/of het filteren van inhoud. Er moet een eigenlijke aanvraag voor de API voor autorisatie worden ingediend voordat de gebruiker toegang krijgt tot de opgegeven bron(nen).
