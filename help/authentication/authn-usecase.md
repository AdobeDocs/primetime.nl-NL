...
| ToestaanMaken | Een Booleaanse waarde die wordt gebruikt om aan te geven of de identiteitsprovider tijdens het uitvoeren van het verzoek een nieuwe id mag maken die de principal vertegenwoordigt. Standaard: true |
| Indeling | Hiermee wordt de URI-referentie opgegeven die overeenkomt met de standaardindeling van de naam-id: urn:oasis:names:tc:SAML:2.0:nameid-format:transient Adobe raadt aan : urn:oasis:names:tc:SAML:2.0:nameid-format:blijvend |
