...
iOS AccessEnabler is een objectief C iOS/tvOS-bibliotheek waarmee mobiele apps Adobe Primetime-verificatie kunnen gebruiken voor de machtigingsservices van TV Anywhere. De uitvoering bestaat uit *AccessEnabled* interface die de API voor machtiging definieert, en de *EntitlementDelegate* en *[EntitlementStatus](#ios%20entitlement%20status)* protocollen die de callbacks beschrijven die de bibliotheek teweegbrengt. De interface samen met het protocol wordt bedoeld onder één gemeenschappelijke naam: de bibliotheek AccessEnabler.
