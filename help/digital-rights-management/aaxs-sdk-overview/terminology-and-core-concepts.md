...
U moet een licentieserver maken en implementeren met de Adobe Access SDK.
...
Het beleid wordt gecreeerd gebruikend de SDK van de Toegang van Adobe.

**Beveiligde inhoud**

*Beveiligde inhoud* (ook wel *verpakte inhoud* genoemd) verwijst naar FLV- en F4V-video-inhoud die is gecodeerd met Adobe Access SDK of andere ondersteunde gereedschappen.
