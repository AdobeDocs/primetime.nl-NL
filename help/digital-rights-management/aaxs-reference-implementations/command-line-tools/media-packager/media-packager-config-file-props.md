...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table_dx4_mpy_n4"> 
 ...
 <tbody class="- topic/tbody "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry ">Geeft aan of scriptgegevens in FLV's moeten worden gecodeerd. <i class="+ topic/ph hi-d/i ">onMetaData</i> - en <i class="+ topic/ph hi-d/i ">onXMP</i> -scripttags worden nooit gecodeerd, zelfs niet als deze optie is ingeschakeld. </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Het PKCS12-bestand met de pakketgegevens voor het ondertekenen van inhoud. Het <span class="codeph"> bestand encrypt.sign.certfile</span> moet verwijzen naar een <span class="filepath"> .pfx</span> -bestand met een certificaat en een persoonlijke sleutel. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
  ...
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Hiermee stelt u de minimale serverversie in die vereist is voor het uitgeven van licenties voor de inhoud die wordt verpakt. Geef x (Adobe Access x.0) op waarbij x = het hoofdreleasenummer. Servers vóór Adobe Access 3.0 bieden geen ondersteuning voor deze instelling. </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
   <td colname="1" class="- topic/entry "><span class="codeph">encrypt.keys.policyFile.n.domain.transportcert</span> </td> 
   <td colname="2" class="- topic/entry "> <p class="- topic/p ">Als een beleid <span class="+ topic/ph pr-d/codeph codeph"> encrypt.keys.policyFile.n</span> domeinregistratie met een server vereist die een verschillend vervoercertificaat gebruikt dan die in <span class="+ topic/ph pr-d/codeph codeph"> encrypt.license.servercert</span>wordt gespecificeerd, moet het certificaat van het domeinvervoer worden verstrekt. </p> <p class="- topic/p ">This property specifies a file that contains the certificate only (either PEM or DER format is acceptable). </p> </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
