...
<table frame="all" colsep="1" rowsep="1" class="+ topic/table adobe-d/table " id="table_a3y_wqy_n4"> 
 ...
 <tbody class="- topic/tbody "> 
  <tr rowsep="1" class="- topic/row "> 
   ...
   <td colname="2" class="- topic/entry ">Hier geeft u de locatie van het configuratiebestand op. Als deze optie niet wordt gebruikt, zal de Manager van de Lijst van de Intrekking <span class="filepath"> flashaccessTools.properties</span> in de het werk folder zoeken. </td> 
  </tr> 
  <tr rowsep="1" class="- topic/row "> 
