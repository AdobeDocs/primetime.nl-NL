...
Deze klasse omvat opmaakgegevens voor Closed Caption-objecten, zoals het lettertype, de tekengrootte, de kleur en de achtergronddekking. Een bijbehorende hulpklasse, `ClosedCaptionStylesBuilder`, maakt het werken met de stijlinstellingen voor een gesloten bijschrift eenvoudiger.
...
1. Wacht tot de MediaPlayer ten minste de status PREPARED heeft (zie [Wacht op een geldige status](../../../tvsdk-1.4-for-desktop-hls/t-psdk-dhls-1.4-configure/c-psdk-dhls-1.4-ui-configure/t-psdk-dhls-1.4-ui-state-prepared-wait-for.md)).
1. Voer een van de volgende handelingen uit om de stijlinstellingen te wijzigen:

   * Gebruik de `ClosedCaptionStylesBuilder` helperklasse (werkt op `ClosedCaptionStyles` achter de schermen).
   * Gebruik de `ClosedCaptionStyles` rechtstreeks.
...
U kunt opmaakinformatie voor Closed Caption-tracks opgeven met de opdracht `ClosedCaptionStyles` klasse. Hiermee stelt u de stijl in voor alle gesloten bijschriften die door de speler worden weergegeven.
...
<table frame="all" colsep="1" rowsep="1" id="table_87205DEFEE384AF4AF83952B15E18A42"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>De grootte van het bijschrift. </p> <p> Kan alleen worden ingesteld op een waarde die wordt gedefinieerd door de <span class="codeph"> ClosedCaptionStyles.FONT_SIZE </span> array: 
