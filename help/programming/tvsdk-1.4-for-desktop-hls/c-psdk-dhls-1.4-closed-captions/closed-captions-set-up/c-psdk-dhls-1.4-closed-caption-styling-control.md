...
# Besturingselement met gesloten bijschrift{#control-closed-caption-styling}
...
Deze klasse omvat opmaakgegevens voor Closed Caption-objecten, zoals het lettertype, de tekengrootte, de kleur en de achtergronddekking. Een gekoppelde hulpklasse, `ClosedCaptionStylesBuilder`, vergemakkelijkt het werken met de stijlinstellingen voor een gesloten bijschrift.
...
1. Wacht op MediaPlayer om minstens de PREPARED status te hebben (zie [Wacht op een geldige staat](../../../tvsdk-1.4-for-desktop-hls/t-psdk-dhls-1.4-configure/c-psdk-dhls-1.4-ui-configure/t-psdk-dhls-1.4-ui-state-prepared-wait-for.md)).
1. Voer een van de volgende handelingen uit om de stijlinstellingen te wijzigen:

   * Gebruik de hulpklasse `ClosedCaptionStylesBuilder` (werkt op `ClosedCaptionStyles` achter de scènes).
   * Gebruik de klasse `ClosedCaptionStyles` rechtstreeks.
...
## Opties voor de stijl van een gesloten bijschrift {#section_D28F50B98C0D48CF89C4FB6DC81C5185}

Met de klasse `ClosedCaptionStyles` kunt u opmaakgegevens opgeven voor Closed Caption-tracks. Hiermee stelt u de stijl in voor alle gesloten bijschriften die door de speler worden weergegeven.
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> <p>De grootte van het bijschrift. </p> <p> Kan alleen worden ingesteld op een waarde die is gedefinieerd door de <span class="codeph"> ClosedCaptionStyles.FONT_SIZE </span>-array: 
     ...
     </ul> </p> <p>Tip:  U kunt de tekengrootte van WebVTT-bijschriften wijzigen door de grootteparameter voor de functie <span class="codeph"> DefaultMediaPlayer.ccStyles setter </span> te wijzigen. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
...
## Voorbeelden: Bijschriftopmaak {#section_63E33840B7A14D26990046E2ACF2ECA1}
