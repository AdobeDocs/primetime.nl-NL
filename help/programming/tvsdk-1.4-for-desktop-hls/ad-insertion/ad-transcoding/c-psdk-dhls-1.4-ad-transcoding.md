...
* `NetworkConfiguration.urlTransformer` Een settermethode die op de `NetworkConfiguration` instantie van metagegevens die moet worden ingesteld `URLTransformer` uitvoering.
