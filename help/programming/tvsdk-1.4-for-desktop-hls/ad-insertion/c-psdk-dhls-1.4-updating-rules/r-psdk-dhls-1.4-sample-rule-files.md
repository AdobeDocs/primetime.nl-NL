...
# Voorbeelden van creatieve selectieregels{#sample-creative-selection-rules}
...
Hier volgt een voorbeeld van een [!DNL AdobeTVSDKConfig.json] bestand dat alleen standaardregels definieert:
...
Hier volgt een voorbeeld van een [!DNL AdobeTVSDKConfig.json] bestand dat standaardregels definieert, plus aanvullende regels voor een specifieke zone-id (in dit geval zone) **1234&quot;**):
