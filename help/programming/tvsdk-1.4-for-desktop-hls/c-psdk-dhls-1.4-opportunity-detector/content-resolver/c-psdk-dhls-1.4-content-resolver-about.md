...
U kunt ook `PSDKConfig.adTags` om meer tags/aanwijzingen voor de standaardmarkeertekens voor advertenties toe te voegen `SpliceOutOpportunityGenerator` klasse en gebruik `PSDKConfig.setSubscribedTags` zodat TVSDK uw toepassing op de hoogte kan stellen van aanvullende tags die informatie over de publicatieworkflow kunnen bevatten.
