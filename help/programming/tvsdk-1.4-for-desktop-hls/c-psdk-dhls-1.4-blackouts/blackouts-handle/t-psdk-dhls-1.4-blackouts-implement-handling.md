...
1. De MediaPlayer voorbereiden op stroomuitval.
...
1. Stel een controle in van de lijst met TimedMetadataObjects voor elke instantie van een update van de positie van de afspeelkop.
