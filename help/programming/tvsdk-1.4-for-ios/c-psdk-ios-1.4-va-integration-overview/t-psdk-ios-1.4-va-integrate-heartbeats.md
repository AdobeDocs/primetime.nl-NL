...
<table id="table_3565328ABBEE4605A92EAE1ADE5D6F84"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Belangrijk:  Dit JSON-configuratiebestand moet ADBMobileConfig.json blijven <span class="codeph"> </span>. De naam en het pad van dit configuratiebestand kunnen niet worden gewijzigd. Het pad naar dit bestand moet <span class="codeph"> &lt;source root&gt;/AdobeMobile zijn </span>. </p> </td> 
  </tr> 
  <tr> 
...
1. Controleer of de opties voor de laadtijd in het `ADBMobileConfig.json` bronbestand correct zijn.
   ...
   1. Bevestig dat dit bestand zich in de `AdobeMobile` map bevindt.
