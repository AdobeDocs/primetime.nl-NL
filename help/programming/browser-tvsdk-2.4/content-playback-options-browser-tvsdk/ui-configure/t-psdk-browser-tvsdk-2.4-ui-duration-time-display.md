...
seo-description: U kunt Browser TVSDK gebruiken om informatie over de media terug te winnen die u op de zoekbalk kunt tonen.
...
1. Gebruik de methoden die beschikbaar zijn in de elementen MediaPlayer en Browser-TVSDK om de zoekbalkparameters in te stellen.

   Hier ziet u bijvoorbeeld een mogelijke lay-out voor het weergeven van de zoekbalk in HTML.
...
1. Luister naar `AdobePSDK.TimeChangeEvent` en werk de zoekbalk dienovereenkomstig bij.
   ...
   In dit voorbeeld wordt een object seekbar gemaakt om de zoekbalk bij te werken:
