...
seo-title: Huidige tijd en resterende tijd weergeven
...
1. Als u een weergave wilt implementeren die de huidige en resterende tijd van de actieve inhoud weergeeft, gebruikt u de volgende voorbeeldcode:
...
1. Gebruik de volgende voorbeeldcode om een weergave te implementeren die de voortgang van een advertentie en de resterende tijd weergeeft:
