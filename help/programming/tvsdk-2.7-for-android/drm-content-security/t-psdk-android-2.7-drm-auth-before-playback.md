...
1. Als de verificatie niet is gelukt, meldt u dit aan de gebruiker en start u het afspelen niet.
   ...
   De toepassing moet eventuele verificatiefouten afhandelen. Verificatie is mislukt voordat TVSDK wordt afgespeeld in een foutstatus en het afspelen wordt gestopt. Uw toepassing moet het probleem oplossen, de speler opnieuw instellen en de bron opnieuw laden.
