...
* `NetworkConfiguration.setURLTransformer` Een settermethode die op de  `NetworkConfiguration` meta-gegevensinstantie wordt verstrekt om de  `URLTransformer` implementatie te plaatsen.
