...
<table frame="all" colsep="1" rowsep="1" id="table_8B61210A406A45ACBE37FC29729DDE22"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> Geen </td> 
   <td colname="4"><span class="codeph"> BESCHRIJVING </span><span class="codeph"> BRON </span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> Geen </td> 
   <td colname="4"> <span class="codeph"> NATIVE_ERROR_CODE </span> <span class="codeph"> NATIVE_ERROR_NAME </span> <span class="codeph"> BESCHRIJVING </span> <span class="codeph"> BESCHRIJVING</span> <p><b>DRM-gegevens:</b> </p> <span class="codeph"> DRM_ERROR_STRING</span> <span class="codeph"> NATIVE_SUBERROR_CODE</span> </td> 
   <td colname="5"> <p>De AVE-bibliotheek op laag niveau heeft een fout gegenereerd. </p> <p>Zie <a href="../../../tvsdk-1.4-for-android/android-1.4-tvsdk-notification/notification-codes/native-error-summary/android-1.4-native-error-summary.md" format="html" scope="external"> Details voor de meldingen NATIVE_ERROR</a> voor informatie over de waarden voor deze metagegevenssleutels. </p> </td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> Geen </td> 
   <td colname="4"><span class="codeph"> BESCHRIJVING </span><span class="codeph"> PLAY_BUFFER_TIME </span> </td> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="3"> Geen </td> 
   <td colname="4"><span class="codeph"> BESCHRIJVING </span><span class="codeph"> INITIAL_BUFFER_TIME </span><span class="codeph"> PLAY_BUFFER_TIME </span> </td> 
  ...
  <tr rowsep="0"> 
   ...
   <td colname="3"> Geen </td> 
   <td colname="4"> Geen </td> 
   <td colname="5"> Geeft een algemene foutgebeurtenis aan. Niet daadwerkelijk uitgegeven door TVSDK. Dit is slechts een markering voor het einde van het bereik van numerieke codes die overeenkomen met TVSDK-foutgebeurtenissen. </td> 
  </tr> 
 </tbody> 
</table>
