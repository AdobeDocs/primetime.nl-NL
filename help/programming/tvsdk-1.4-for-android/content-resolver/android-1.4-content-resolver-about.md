...
* `AuditudeResolver` voor `AUDITUDE_METADATA_KEY`, dat kan communiceren met Adobe Primetime en beslissingsservers (voorheen Auditude genoemd) en dat ad-hocafbrekingen kunnen retourneren die moeten worden geplaatst.
