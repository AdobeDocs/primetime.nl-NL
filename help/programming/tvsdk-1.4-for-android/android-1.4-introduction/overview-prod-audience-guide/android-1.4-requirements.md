---
description: TVSDK vereist specifieke vereisten voor media-, manifestinhoud, DRM- en softwareversies.
title: Eisen
...
TVSDK vereist specifieke vereisten voor media-, manifestinhoud, DRM- en softwareversies.
...
De versie van `#EXT-X-VERSION` in het [!DNL .m3u8] bestand bepaalt welke functies voor uw toepassing beschikbaar zijn en welke `EXT` tags geldig zijn in uw afspeellijst/manifest.
