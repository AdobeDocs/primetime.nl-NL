...
Ga naar de [Adobe Primetime API-referenties als u de volledige API-documentatie voor TVSDK wilt bekijken](https://help.adobe.com/en_US/primetime/api/index.html#api-Adobe_Primetime_API_References).
...
<table frame="all" colsep="1" rowsep="1" id="table_2801E01282A948E6917910CA2FD1E05C"> 
 ...
 <tbody> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interface voor het maken van opportuniteitsdetectors. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Factory-klasse waarmee het ad-beslissingsproces kan worden aangepast. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse die alle parameters van de buffercontrole inkapselt. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Standaardimplementatie voor gedrag bij het afspelen van advertenties. Interface die toepassingen toestaat om ad gedrag aan te passen.</td> 
  </tr> 
  <tr rowsep="1"> 
  ...
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interface-definitie van een set callbacks die tijdens het afspelen van een advertentie moet worden aangeroepen. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interfacedefinitie van een callback die moet worden aangeroepen wanneer beveiligde metagegevens beschikbaar komen. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Markeringsinterface die wordt gebruikt om de registratie van de gebeurtenislistener te verenigen. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interface-definitie van een set callback die tijdens het afspelen moet worden aangeroepen. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> De definitie van de interface van een reeks callback die tijdens QoS moet worden aangehaald. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interface die audio-videomedia vertegenwoordigt. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse die een mediaspeler laadt en het bijbehorende MediaPlayerItem-object maakt. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interface die de listenermethoden definieert die aan het MediaPlayerItemLoader-object zijn gekoppeld. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse voor de weergave die door de MediaPlayer wordt gebruikt voor het renderen van video. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse die alle informatie over een mediabron omvat. Omvat opsomming voor Type van media middel. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interface die voor verwerking in-manifest aanwijzingen wordt gebruikt die als plaatsen voor het ad besluitvormingsproces zullen worden gebruikt. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klasse die naast de standaardactielabels ook de aangepaste tags omvat die door de mediaspeler worden gebruikt bij het uitvoeren van de advertentie. Het bevat ook de tagnamen waarvan de toepassing op de hoogte wil worden gesteld. </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Interface die verschillende kenmerken omvat die een tekststijl beschrijven (bijvoorbeeld, de gesloten titelstijl). </td> 
  </tr> 
  <tr rowsep="1"> 
   ...
   <td colname="2"> Klassemethoden voor het instellen van de opmaak van tekst. </td> 
  </tr> 
  <tr rowsep="0"> 
   <td colname="1"><span class="codeph"><a href="https://help.adobe.com/en_US/primetime/api/psdk/javadoc_1.4/com/adobe/mediacore/Version.html" format="html" scope="external"> Versie</a></span> </td> 
   <td colname="2"> Klasse die de versie en beschrijving van TVSDK bevat. </td> 
  </tr> 
 </tbody> 
</table>
