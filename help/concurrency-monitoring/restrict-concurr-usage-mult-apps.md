...
Voor integratie met CM moet een Zendesk-ticket (https://adobeprimetime.zendesk.com) worden gemaakt en moet de volgende informatie worden gespecificeerd:

1. de naam van de onderneming
1. de toepassingen die u met CM wilt integreren. Voor elke toepassing moet u het volgende opgeven:
   - toepassingsnaam
   - toepassingsplatform
1. de derde die om de integratie heeft verzocht (indien van toepassing)


Nadat u het ticket hebt gemaakt, wordt de volgende informatie vrijgegeven voor gebruik:
...
| interval voor hartslagen | Interval in seconden om hartslagvraag naar Adobe te verzenden | 60 | 60 |
...
De volgende artikelen MOETEN in de aanvraag(en) worden verpakt:
