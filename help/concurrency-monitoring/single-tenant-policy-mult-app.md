...
Programmer P heeft een iPhone-toepassing, een iPad-toepassing en een website. Deze functie moet worden geïntegreerd met CCM (Adobe Concurency Monitoring) om het aantal gelijktijdige streams tussen deze apps te beperken. De programmeur zal beleid tot stand brengen dat gelijktijdig gebruik zal beperken. We zullen twee voorbeelden bekijken:
...
## Een beleid met één regel

Ons eerste beleid bevat één regel: er zijn maximaal twee gelijktijdige streams toegestaan. De eerste stream die wordt gestart, wordt gestopt als drie gelijktijdige streams worden afgespeeld.

Twee apps + één website worden gebruikt om streams te starten:
