...
# Serverqueryparameters manipuleren {#ms-query-params}
...
## Herkende parameters {#section_072845B7FA94468C8068E9092983C9E6}
...
| `ptcdn` | Lijst van één of meerdere CDNs aan gastheer transcoded activa. Zie [Ondersteuning voor meerdere CDN](/help/primetime-ad-insertion/~old-creative-repackaging-service/multi-cdn-supportt.md). | Geen (standaard=Akamai) | Voorbeeld: Akamai, Level3, Limelight, Comcast |
| `ptcueformat` | De naam van de aangepaste ad-cueformaat in de M3U8. | Nee | DPISimple, DPIScte35, Element,NBC, NFL of Turner |
| `ptfailover` | Signaleert de manifestserver om primaire en failover stromen te identificeren die in master playlist worden gespecificeerd, en hen te behandelen als gescheiden reeksen. Dit vergemakkelijkt failover en voorkomt timingsfouten. (Alleen voor Apple HLS-apparaten). Zie [HLS-speler-switching faciliteren](/help/primetime-ad-insertion/~old-msapi-topics/ms-insert-ads/hls-switching-to-failover.md). | Nee | true |
| `ptmulticall` | Indien ingesteld op true, worden meerdere controles ad-call voor FER uitgevoerd; één voor elke advertentie-onderbreking. Indien afwezig of geplaatst aan vals, wordt één ad-call gemaakt om voor FER te controleren. | Nee | Booleaans <br> **Opmerking**: De volgende eisen: <ul><li>`ptcueformat` parameter moet op nbc worden ingesteld</li><li>parameter pttimeline wordt genegeerd.</li></ul> |
